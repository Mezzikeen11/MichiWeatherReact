...
<div className="text-[#4a5a4a] dark:text-gray-300 text-base leading-relaxed mb-6 font-medium italic border-l-4 border-[#2d7a2d] pl-4" style={{ fontFamily: 'inherit' }}> "{cat.descripcion}"
...
<FiSend size={20} /> Enviar solicitud </button>
</form>
</motion.div>
